...
class EntityClass extends Component{
    ...
    handleOk(flag) {
        if (flag === "ADD"){
            ...
            this.FlowClassService.installEntityClass(data).then(res=> {
                if (res.data.code > 0) {
            ...
            this.FlowClassService.updateEntityClass({categoryName:data.categoryName,categoryId: data.categoryId}).then(res=> {
                if (res.data.code > 0) {
...
export default Form.create("EntityClass")(EntityClass);