...
class FormClass extends Component{
    ...
    handleOk(flag) {
        if (flag === "ADD"){
            ...
            this.FlowClassService.installFormClass(data).then(res=> {
                if (res.data.code > 0) {
            ...
            this.FlowClassService.updateFormClass({categoryName:data.categoryName, categoryId:data.categoryId}).then(res=> {
                if (res.data.code > 0) {
...
export default Form.create("FormClass")(FormClass);