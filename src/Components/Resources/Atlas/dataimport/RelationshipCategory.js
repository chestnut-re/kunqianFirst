...
const { Option } = Select;
class RelationshipCategory extends Component{
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return(
            <div>导入关系类别
                <Form.Item label={"导入关系类别数据"} style={{ marginLeft: '24px' }}>
                    {getFieldDecorator('modelType', {})(<Select placeholder={"请选择关系类别数据"} style={{ width: '200px' }}>
...
export default Form.create()(RelationshipCategory)