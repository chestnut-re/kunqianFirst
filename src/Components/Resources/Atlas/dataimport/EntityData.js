...
class EntityData extends Component{
    ...
    render() {
        ...
        return(
            <div>导入实体数据
                <Form.Item label={"导入实体数据"} style={{ marginLeft: '24px' }}>
                    {getFieldDecorator('modelType', {})(<Select placeholder={"请选择实体数据"} style={{ width: '200px' }}>
...
export default Form.create()(EntityData)